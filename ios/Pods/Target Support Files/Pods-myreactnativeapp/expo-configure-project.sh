...
with_node \
  ...
  --target "/Users/maximilianpeh/appli/ios/Pods/Target Support Files/Pods-myreactnativeapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/maximilianpeh/appli/ios/myreactnativeapp/myreactnativeapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient"
